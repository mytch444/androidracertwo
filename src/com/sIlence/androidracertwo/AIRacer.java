...
public class AIRacer extends LightRacer {
	...
	if (dieing > 0) {
		...
		if (!foundSpawn) {
		    spawn(view.getDeaths() * view.getDeaths() + STANDARD_LENGTH);
		} else {
		    spawnSpec(linex[0], liney[0], safestDirection(), view.getDeaths() * view.getDeaths() + STANDARD_LENGTH);
		}
    ...
    protected void newLine() {
        ...
        linex = new int[view.getDeaths() * view.getDeaths() + STANDARD_LENGTH];
        liney = new int[view.getDeaths() * view.getDeaths() + STANDARD_LENGTH];
    }
}